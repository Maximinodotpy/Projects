...
<div class="flex items-center justify-between transition-all grow bg-neutral-700" style="margin-left: {getDayProgress(sunrise) * 100}vw; width: { sunset.diff(sunrise, 'seconds') / SECONDS_IN_DAY * 100 }vw">
