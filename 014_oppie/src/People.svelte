...
<div id="people" class="text-white bg-neutral-900 pt-20">

    
    <div class="p-8">
        <div class="container">
            <h2 class="text-5xl mb-4">People</h2>
            <p class="text-lg">This is a list of people who were involved in the development of the atomic bomb.</p>
    
            <label for="coverImages" class="inline-flex items-center mt-4 btn-dark gap-3">
                Cover images
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 p-8">
        ...
        <div class="rounded-lg shadow-lg p-4 bg-neutral-800">
            <div class="mb-6">
            ...
            <div class="grid grid-cols-2 gap-4">
                {#each person.real_pictures ?? [] as picture}
                    <div>
                        ...
                        <p class="overflow-hidden whitespace-nowrap text-ellipsis text-sm">{ picture.alt }</p>
                    </div>
                {/each}
            </div>
        </div>
